...
import ChuyenKhoaServices from '@services/ChuyenKhoaServices';
import ImageServices from '@services/ImageServices';

export const getAllChuyenKhoa = () => {
  return dispatch => {
    dispatch({type: ActionTypes.GET_CHUYENKHOA_REQUEST});

    return ChuyenKhoaServices.getAllChuyenKhoa()
      .then(({data}) => {
        dispatch({type: ActionTypes.GET_CHUYENKHOA_SUCCESS, data});
      })
      .catch(message => {
        dispatch({type: ActionTypes.GET_CHUYENKHOA_FAIL, message});
      });
  };
};
...
//       image: params.image,
//     };
//     return ChuyenKhoaServices.addCategory(body)
//       .then(({data}) => {
...
//   return ChuyenKhoaServices.deleteCategory(categoryId)
//     .then(() => {
//       dispatch({type: ActionTypes.DELETE_CATEGORY_SUCCESS, id: categoryId});
//     })
//     .catch(message => {
...
//   return ChuyenKhoaServices.editCategory(params)
//     .then(({data}) => {
...
//         }
//         const {data} = await ChuyenKhoaServices.addCategory(params);
...
//           params.image = imageUploaded.file;
//         }
//         const {data} = await ChuyenKhoaServices.editCategory(params);
//         return data;
//       } catch (error) {
//         return error;
//       }
...
//       try {
//         const {data} = await ChuyenKhoaServices.deleteCategory(id);
//         return {...data, id};
//       } catch (error) {
//         return error;
//       }
